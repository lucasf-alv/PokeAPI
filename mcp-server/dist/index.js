...
server.registerTool("search_pokemon", {
...
server.registerTool("get_pokemon_by_type", {
...
server.registerTool("get_evolution_chain", {
...
server.registerTool("get_pokemon_list", {
...
server.registerTool("get_pokemon_page", {
    description: "Retorna uma página de Pokémon com imagem, tipos e todas as estatísticas.",
    inputSchema: z.object({
