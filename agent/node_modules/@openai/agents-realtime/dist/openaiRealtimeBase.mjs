...
export class OpenAIRealtimeBase extends EventEmitterDelegate {
    ...
    resetHistory(oldHistory, newHistory) {
        ...
        if (rejectedMcpItem) {
            ...
            throw new UserError(`MCP items cannot be added or updated via updateHistory(). Found ${detail}. Leave existing MCP items unchanged, or remove them from history entirely, before calling updateHistory().`);
        }
