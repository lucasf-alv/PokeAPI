 ...
 */
class RunInputItem extends RunItemBase {
    rawItem;
    agent;
    inputId;
    type = 'input_item';
    constructor(rawItem, agent, inputId = (0, _shims_1.randomUUID)()) {
        super();
...
exports.RunInputItem = RunInputItem;
