 ...
 */
export function isGpt5OrNewerReasoningModel(modelName) {
    if (GPT_5_CHAT_MODEL_PATTERNS.some((pattern) => pattern.test(modelName))) {
        return false;
    }
 ...
 */
export function isGpt5OrNewerDefault() {
...
export function getDefaultModel() {
    const env = loadEnv();
    return (env[OPENAI_DEFAULT_MODEL_ENV_VARIABLE_NAME]?.toLowerCase() ?? 'gpt-5.6-luna');
}
/**
