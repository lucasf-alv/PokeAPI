...
import { prepareAgentArtifacts, trackDeferredToolRecovery, } from "./runner/modelPreparation.mjs";
            ...
            try {
                while (true) {
                    ...
                    if (state._currentStep.type === 'next_step_run_again') {
                        ...
                        trackDeferredToolRecovery(state, state._currentAgent, processedResponse);
        ...
        try {
            while (true) {
                ...
                if (result.state._currentStep.type === 'next_step_run_again') {
                    ...
                    trackDeferredToolRecovery(result.state, currentAgent, processedResponse);
