import logger, { logModelAndToolActionError } from "../logger.mjs";
...
import { NOOP_TRACE_OR_SPAN_ID } from "./utils.mjs";
function isNoopSpan(span) {
    return (span.traceId === NOOP_TRACE_OR_SPAN_ID ||
        ...
        const exportBatch = async (batch) => {
            ...
            const exportPromise = (async () => {
                try {
                    ...
                    logModelAndToolActionError(logger, 'Tracing exporter failed to export batch', error);
                }
                finally {
