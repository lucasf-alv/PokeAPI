...
export declare class RunItemBase {
    ...
    toJSON(): {
        ...
        rawItem: {
            ...
            providerData?: Record<string, any> | undefined;
            id?: string | undefined;
            toolSearchAgentName?: string | undefined;
            call_id?: string | null | undefined;
            callId?: string | null | undefined;
            execution?: "client" | "server" | undefined;
            status?: string | undefined;
 ...
 */
export declare class RunInputItem extends RunItemBase {
    rawItem: protocol.ModelItem;
    agent: Agent<any, any>;
    inputId: string;
    readonly type: "input_item";
    constructor(rawItem: protocol.ModelItem, agent: Agent<any, any>, inputId?: string);
    toJSON(): {
        agent: {
            name: string;
        };
...
export type RunItem = RunInputItem | RunMessageOutputItem | RunToolCallItem | RunToolSearchCallItem | RunToolSearchOutputItem | RunReasoningItem | RunCompactionItem | RunHandoffCallItem | RunToolCallOutputItem | RunHandoffOutputItem | RunToolApprovalItem;
/**
