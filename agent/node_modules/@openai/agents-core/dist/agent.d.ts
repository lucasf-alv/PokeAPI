 ...
 */
export type AgentOutputType<HandoffOutputType = UnknownContext> = TextOutput | ZodObjectLike | StandardSchemaWithJSON<any, any> | JsonSchemaDefinition | HandoffsOutput<HandoffOutputType>;
/**
