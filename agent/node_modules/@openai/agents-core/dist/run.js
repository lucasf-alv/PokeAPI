            ...
            try {
                while (true) {
                    ...
                    if (state._currentStep.type === 'next_step_run_again') {
                        ...
                        (0, modelPreparation_1.trackDeferredToolRecovery)(state, state._currentAgent, processedResponse);
        ...
        try {
            while (true) {
                ...
                if (result.state._currentStep.type === 'next_step_run_again') {
                    ...
                    (0, modelPreparation_1.trackDeferredToolRecovery)(result.state, currentAgent, processedResponse);
