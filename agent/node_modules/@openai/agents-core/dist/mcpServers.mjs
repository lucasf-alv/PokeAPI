...
export class MCPServers {
    ...
    get active() {
        ...
        return this.allServers.filter((server) => this.connectedServerSet.has(server));
    }
    get failed() {
    ...
    refreshActiveServers() {
        logger.debug(`Active MCP servers: ${this.active.length}; failed: ${this.failedServers.length}.`);
    }
