    ...
    for (const output of modelResponse.output) {
        ...
        if (resolved.type === 'not_found') {
            ...
            if (!checkDeferredFunctionToolLoaded(output, resolved.tool, loadedDeferredToolState.loadedToolNames, agent, toolNotFoundBehavior)) {
                recordMissingFunctionTool(normalizeFunctionToolCallForStorage(output, resolved.tool), getFunctionToolQualifiedName(resolved.tool) ?? resolved.tool.name, agent, items, toolsUsed, functionToolsNotFound, 'not_loaded');
                continue;
            }
