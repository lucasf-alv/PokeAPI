...
import { RunInputItem, RunToolSearchOutputItem } from "../items.mjs";
 ...
 */
export function getServerConversationOwner(conversationId, previousResponseId) {
...
function getServerItemKey(item) {
    return getAgentInputItemKey(item.type === 'tool_search_output'
...
export class ServerConversationTracker {
    ...
    trackServerItems(modelResponse, processedItems = []) {
        ...
        const searchOutputs = processedItems.filter((item) => item instanceof RunToolSearchOutputItem);
