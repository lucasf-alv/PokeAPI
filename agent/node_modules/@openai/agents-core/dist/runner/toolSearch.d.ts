...
import { type FunctionTool, type HostedMCPTool, type Tool } from '../tool';
import type * as protocol from '../types/protocol';
import { type FunctionToolLookupKey } from '../toolIdentity';
export declare function isDeferredHostedMcpTool(tool: Tool<any>): tool is HostedMCPTool<any>;
...
export declare function filterEnabledToolSearchRuntimeTools<TContext>(args: {
    agent: Agent<TContext, any>;
    runContext: RunContext<TContext>;
    runtimeTools: Tool<TContext>[];
}): Promise<Tool<TContext>[]>;
export declare function registerRuntimeToolSearchTools<TContext>(args: {
