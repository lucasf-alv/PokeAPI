...
import { readZodDefinition, readZodDescription, readZodType, } from "./zodCompat.mjs";
...
export function zodJsonSchemaCompatForOpenAIStrict(input) {
    return convertZodObjectSchema(input, {
...
export function assertLosslessOpenAIStrictZodSchemaConversion(conversion) {
    if (!conversion.losslessForWholeSchemaFallback) {
        throwLossyZodIntersectionFallback();
    }
}
function throwLossyZodIntersectionFallback() {
    throw new UserError('Cannot convert this Zod schema with an intersection to OpenAI strict mode without losing constraints. Use unconstrained compatible intersections, combine the fields into one Zod object, or disable strict mode.');
}
...
function throwUnsupportedZodIntersection() {
    throw new UserError('Cannot convert this Zod intersection to an OpenAI strict schema. Use compatible Zod object intersections with distinct properties and closed object branches, combine the fields into one Zod object, or disable strict mode.');
}
