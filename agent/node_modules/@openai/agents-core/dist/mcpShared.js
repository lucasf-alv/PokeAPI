...
exports.MCPTool = exports.BaseMCPServerSSE = exports.BaseMCPServerStreamableHttp = exports.BaseMCPServerStdio = exports.DEFAULT_SSE_MCP_CLIENT_LOGGER_NAME = exports.DEFAULT_STREAMABLE_HTTP_MCP_CLIENT_LOGGER_NAME = exports.DEFAULT_STDIO_MCP_CLIENT_LOGGER_NAME = void 0;
exports.attachCallToolResultMetadata = attachCallToolResultMetadata;
...
class BaseMCPServerStdio {
    ...
    debugLog(buildMessage) {
        if (!this.logger.dontLogToolData && debug_1.default.enabled(this.logger.namespace)) {
...
function attachCallToolResultMetadata(content, metadata) {
