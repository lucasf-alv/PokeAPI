...
exports.MOUNT_CREDENTIAL_EXPOSURE_POLICY_KEYS = exports.EnvValueReference = exports.Manifest = exports.Environment = void 0;
...
exports.manifestAcknowledgesInContainerMountCredentialExposure = manifestAcknowledgesInContainerMountCredentialExposure;
exports.copyManifestMountCredentialExposurePolicy = copyManifestMountCredentialExposurePolicy;
exports.replaceManifestMountCredentialExposurePolicy = replaceManifestMountCredentialExposurePolicy;
...
const typedMountConfig_1 = require("./shared/typedMountConfig.js");
class Environment {
    value;
    resolver;
    ephemeral;
...
class Manifest {
    ...
    constructor(init = {}) {
        if (exports.MOUNT_CREDENTIAL_EXPOSURE_POLICY_KEYS.some((key) => key in init)) {
...
exports.MOUNT_CREDENTIAL_EXPOSURE_POLICY_KEYS = [
...
function manifestAcknowledgesInContainerMountCredentialExposure(manifest, mountPath, authority) {
...
function copyManifestMountCredentialExposurePolicy(target, ...sources) {
    const policy = {
...
function replaceManifestMountCredentialExposurePolicy(target, source) {
...
function normalizeTypedMountProvider(entry) {
    ...
    const { provider, config } = (0, typedMountConfig_1.typedMountProviderConfig)(entry);
