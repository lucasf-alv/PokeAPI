...
function handoff(agent, config = {}) {
    ...
    if (hasInputType && config.onHandoff == null) {
        throw new errors_1.UserError('You must provide `onHandoff` when `inputType` is provided.');
    }
    ...
    if (hasInputType) {
        const result = (0, tools_2.getSchemaAndParserFromInputType)(inputType, handoff.toolName, { strict: true });
