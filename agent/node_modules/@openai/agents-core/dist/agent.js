...
class Agent extends lifecycle_1.AgentHooks {
    ...
    constructor(config) {
        ...
        if (config.outputType) {
            if (!(0, typeGuards_1.isZodObject)(config.outputType) &&
                (0, standardSchema_1.hasStandardSchemaMarker)(config.outputType) &&
                !(0, standardSchema_1.isStandardSchemaWithJSON)(config.outputType)) {
                throw (0, standardSchema_1.unsupportedStandardSchemaError)();
            }
            if (!(0, typeGuards_1.isZodObject)(config.outputType) &&
                (0, standardSchema_1.isStandardSchemaWithJSON)(config.outputType)) {
                const inputSchema = (0, standardSchema_1.standardSchemaToJsonSchema)(config.outputType, 'input');
                (0, standardSchema_1.assertStandardSchemaObjectRoot)(inputSchema, 'Agent output');
                (0, strictToolSchema_1.prepareOpenAIStrictToolSchema)(inputSchema);
            }
        ...
        config.model !== undefined &&
            ...
            (0, defaultModel_1.isGpt5OrNewerDefault)() &&
            // The specified model is outside that settings family.
            (typeof config.model !== 'string' ||
                !(0, defaultModel_1.isGpt5OrNewerReasoningModel)(config.model)) &&
    ...
    get outputSchemaName() {
        ...
        else if ((0, standardSchema_1.isStandardSchemaWithJSON)(this.outputType)) {
    ...
    processFinalOutput(output) {
        ...
        if (typeof this.outputType === 'object' ||
            ...
            if ((0, standardSchema_1.isStandardSchemaWithJSON)(this.outputType)) {
                const inputSchema = (0, standardSchema_1.standardSchemaToJsonSchema)(this.outputType, 'input');
                (0, standardSchema_1.assertStandardSchemaObjectRoot)(inputSchema, 'Agent output');
                const normalized = (0, strictToolSchema_1.prepareOpenAIStrictToolSchema)(inputSchema).normalizeInput(parsed);
                return (0, standardSchema_1.validateStandardSchema)(this.outputType, normalized);
            }
            if ((0, standardSchema_1.hasStandardSchemaMarker)(this.outputType)) {
                throw (0, standardSchema_1.unsupportedStandardSchemaError)();
            }
            return parsed;
        }
