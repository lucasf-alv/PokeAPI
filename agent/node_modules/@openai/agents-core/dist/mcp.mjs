...
import { beginServerToolsCacheListing, cachedMcpToolKeysByServer as _cachedToolKeysByServer, cachedMcpTools as _cachedTools, } from "./mcpToolCache.mjs";
import { getToolCallParentSpanFromDetails } from "./agentToolRunConfig.mjs";
import { assertOpenAIStrictToolSchemaPreservesOpenObjects, isJsonSchemaDepthError, } from "./utils/strictToolSchema.mjs";
...
async function getMcpToolsFromServer({ server, runContext, agent, generateMCPToolCacheKey, tracingParent, }) {
    ...
    try {
        ...
        return await withMCPListToolsSpan(listToolsForServer, {
