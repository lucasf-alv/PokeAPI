...
exports.isGpt5OrNewerReasoningModel = isGpt5OrNewerReasoningModel;
exports.isGpt5OrNewerDefault = isGpt5OrNewerDefault;
 ...
 */
function isGpt5OrNewerReasoningModel(modelName) {
    if (GPT_5_CHAT_MODEL_PATTERNS.some((pattern) => pattern.test(modelName))) {
        return false;
    }
...
function getDefaultModel() {
    ...
    return (env[exports.OPENAI_DEFAULT_MODEL_ENV_VARIABLE_NAME]?.toLowerCase() ?? 'gpt-5.6-luna');
}
/**
