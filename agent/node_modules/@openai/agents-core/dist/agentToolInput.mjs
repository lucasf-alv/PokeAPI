import { z } from 'zod';
import { readZodDefinition, readZodDescription, readZodType, } from "./utils/zodCompat.mjs";
...
import { isStandardSchemaWithJSON, standardSchemaToJsonSchema, } from "./utils/standardSchema.mjs";
...
function buildSchemaSummary(parameters) {
    ...
    if (isStandardSchemaWithJSON(parameters)) {
        const summary = summarizeJsonSchema(standardSchemaToJsonSchema(parameters, 'input'));
        return summary ? formatSchemaSummary(summary) : undefined;
    }
