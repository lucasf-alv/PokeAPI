...
function itemsToMessages(items, options = {}) {
    ...
    let pendingAssistantFunctionCallProviderData = {};
    ...
    const takeReasoningOnlyAssistantMessage = () => {
        const pending = currentAssistantMsg;
        if (!pending ||
    ...
    for (const item of items) {
        if (isMessageItem(item)) {
            ...
            const pendingAssistantToolCallMessage = role === 'assistant' &&
                currentAssistantMsg?.content === null &&
                currentAssistantMsg.tool_calls &&
                currentAssistantMsg.tool_calls.length > 0
                ? currentAssistantMsg
                : undefined;
            const pendingReasoningMsg = role === 'assistant' && !pendingAssistantToolCallMessage
            ...
            if (role === 'assistant') {
                ...
                const assistant = {
                    ...
                    ...(typeof (pendingReasoningMsg?.reasoning ??
                        pendingAssistantToolCallMessage?.reasoning) === 'string'
                        ? {
                ...
                if (pendingAssistantToolCallMessage) {
                    ...
                    Object.assign(pendingAssistantToolCallMessage, assistant, pendingAssistantFunctionCallProviderData);
                }
                else {
            ...
            const assistantProviderData = (0, providerData_1.getProviderDataWithoutReservedKeys)(funcCall.providerData, ['role', 'content', 'tool_calls', 'audio', 'id', 'type', 'function']);
            toolCalls.push({
                id: funcCall.callId,
                type: 'function',
                function: {
            ...
            asst.tool_calls = toolCalls;
            Object.assign(pendingAssistantFunctionCallProviderData, assistantProviderData);
