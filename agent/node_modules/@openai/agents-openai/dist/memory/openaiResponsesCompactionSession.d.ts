...
import type { AgentInputItem, OpenAIResponsesCompactionArgs, OpenAIResponsesCompactionOwnershipAwareSession as OpenAIResponsesCompactionSessionLike, RunContext, Session } from '@openai/agents-core';
...
export declare class OpenAIResponsesCompactionSession implements OpenAIResponsesCompactionSessionLike, OpenAISessionApiTagged<'responses'> {
    ...
    private readonly compactionOwnership;
    constructor(options: OpenAIResponsesCompactionSessionOptions);
    runCompaction(args?: OpenAIResponsesCompactionArgs, _runContext?: RunContext<any>, ownership?: object | null): Promise<OpenAIResponsesCompactionResult | null>;
    private runCompactionOperation;
    getSessionId(): Promise<string>;
    getItems(limit?: number): Promise<AgentInputItem[]>;
    getItemsWithCompactionOwnership(_runContext?: RunContext<any>): Promise<{
        items: AgentInputItem[];
        ownership: object;
    }>;
    prepareHistoryItemsForPersistenceComparison(items: AgentInputItem[]): AgentInputItem[];
    addItems(items: AgentInputItem[]): Promise<void>;
    addItemsWithCompactionOwnership(items: AgentInputItem[], ownership: object | null, _runContext?: RunContext<any>): Promise<void>;
    popItem(): Promise<AgentInputItem | undefined>;
    clearSession(): Promise<void>;
    private ownsCompaction;
    private runMutationOperation;
