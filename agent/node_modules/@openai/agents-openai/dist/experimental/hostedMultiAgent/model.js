...
class OpenAIHostedMultiAgentModel extends openaiResponsesModel_1.OpenAIResponsesModel {
    ...
    /** @internal */
    _getUnsuccessfulResponseTerminalType() {
        return undefined;
    }
    ...
    async *#runWebSocketTurn(request, endpointMetadata) {
        ...
        try {
            ...
            }, Boolean(this.#activeResponse), builtRequest.signal, requestTimeoutDeadline, endpointMetadata);
    ...
    async #ensureWebSocket(transportOptions, activeResponse, signal, requestTimeoutDeadline, endpointMetadata) {
        if (signal?.aborted) {
            throw new openai_1.default.APIUserAbortError();
        }
