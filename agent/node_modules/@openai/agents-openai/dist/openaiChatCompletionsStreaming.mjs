...
import { createTruncatedEmptyChatCompletionError, isTruncatedEmptyChatCompletion, } from "./openaiChatCompletionsTruncation.mjs";
...
export async function* convertChatCompletionsStreamToResponses(response, stream, options = {}) {
    ...
    if (isTruncatedEmptyChatCompletion({
        finishReason: state.finishReason,
